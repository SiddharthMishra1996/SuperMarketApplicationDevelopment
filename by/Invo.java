   ...
   float tp=0;
    public Invo() {
       ...
       try
       {
           ...
           ResultSet s=stm.executeQuery("Select * from invoice"); 
           while(s.next())
           {
               model.addRow(new Object[]{s.getString("Name"),s.getString("Type"),s.getString("Size"),s.getString("Price"),s.getInt("Quantity"),s.getFloat("NetPrice")});
                tp+=s.getFloat("NetPrice");
           }
           jTextField6.setText(Float.toString(tp));
       }catch(Exception e){}
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Time(hh/mm/ss)       :");

        jLabel8.setText(".................................................................................................................................................................");

        jLabel9.setText("INVOICE DETAILS :");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product Name", "Product Type", "Size", "Price per head", "Quantity", "Net price"
            }
        ) {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(jTextField3, javax.swing.GroupLayout.PREFERRED_SIZE, 516, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try
       {Statement stm=con.createStatement();
       stm.executeUpdate("delete from invoice"); 
       }catch(Exception e){}
       setVisible(false);
